...
y_data = df_data['schedule_rate'].tolist()
...
params = {'eta': 0.05, 'objective': 'reg:linear', 'eval_metrics': 'rmse', 'colsample_bytree': 0.8, 'max_depth': 4,
          'subsample': 0.8}
...
bst.save_model('schedule_rate_predict.model')
plot_importance(bst)
pyplot.show()
